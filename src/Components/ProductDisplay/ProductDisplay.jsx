    ...
    <div className='product-display'>
        <div className="product-display-left">
            ...
            <div className="product-display-image">
                <img src={product.image} alt="" className='product-display-main-image'/>
            </div>
        </div>
        <div className="product-display-right">
            ...
            <div className="product-display-right-prices">
                <div className="product-display-right-price-old">₦{product.old_price.toLocaleString()}</div>
                <div className="product-display-right-price-new">₦{product.new_price.toLocaleString()}</div>
            </div>
